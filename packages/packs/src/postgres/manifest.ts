  ...
  probes: [
    {
      ...
      params: {
        ...
        user: { type: 'string', description: 'Database user', required: false, default: 'postgres' },
      },
      timeout: 15_000,
    },
    {
    ...
    },
    {
      ...
      params: {
        ...
        port: { type: 'number', description: 'Database port', required: false, default: 5432 },
        user: { type: 'string', description: 'Database user', required: false, default: 'postgres' },
        thresholdMs: { type: 'number', description: 'Slow query threshold in ms', required: false, default: 1000 },
      },
      timeout: 15_000,
    },
  ],
